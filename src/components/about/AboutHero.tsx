...
export default function AboutHero() {
  return (
    <section className="bg-[#0B0F19] text-white px-8 lg:px-16 pt-40 pb-22 border-b border-white/5 backdrop-blur-xl relative overflow-hidden ">
      ...
      <div className="max-w-5xl mx-auto text-center">
        <div className="badge badge-outline border-[#ff7900] text-[#ff7900] p-4 mb-8">
          🔥 About UMAKAN
        </div>
